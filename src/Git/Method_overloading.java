...
//	 class Overload {
//	 //
//	 double  calcOverload(int marks1) { // Return type of method
...
//	 class Overload {
//	 private double calcAverage(int marks1) { // Access public
//	 return (marks1) / 2.0;
//	 }
//	
//	 public double calcAverage(int marks1, int marks2) {// Access private
